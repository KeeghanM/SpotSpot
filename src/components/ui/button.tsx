...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-pointer transform hover:-translate-y-0.5",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          'border-2 border-pink-200 bg-white shadow-sm hover:bg-pink-50 hover:border-pink-300 text-pink-700 dark:bg-pink-900/10 dark:border-pink-700 dark:hover:bg-pink-800/20',
        secondary:
